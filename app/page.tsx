...
type ProductCategory = "all" | "dairy" | "cleaning" | "motors" | "pumps" | "agriculture" | "pulverisers" | "compressors";
...
const products: Product[] = [
  {category:"dairy",brand:"Kamdhenu",nameEn:"Cream Separator 60 LPH",nameHi:"क्रीम सेपरेटर 60 एलपीएच",capacity:"60 LPH",detailsEn:"For small dairy farms and low-volume milk separation.",detailsHi:"छोटे डेयरी फार्म और कम मात्रा में दूध से क्रीम अलग करने के लिए।",image:"kamdhenu-cream-separator-60-lph.svg"},
  {category:"dairy",brand:"Kamdhenu",nameEn:"Cream Separator 165 LPH",nameHi:"क्रीम सेपरेटर 165 एलपीएच",capacity:"165 LPH",detailsEn:"For dairy farms and milk collection points.",detailsHi:"डेयरी फार्म और दूध संग्रह केंद्रों के लिए।",image:"kamdhenu-cream-separator-165-lph.svg"},
  {category:"dairy",brand:"Kamdhenu",nameEn:"Cream Separator 300 LPH",nameHi:"क्रीम सेपरेटर 300 एलपीएच",capacity:"300 LPH",detailsEn:"For small commercial dairy processing.",detailsHi:"छोटे व्यावसायिक डेयरी प्रसंस्करण के लिए।",image:"kamdhenu-cream-separator-300-lph.svg"},
  {category:"dairy",brand:"Kamdhenu",nameEn:"Cream Separator 450 LPH",nameHi:"क्रीम सेपरेटर 450 एलपीएच",capacity:"450 LPH",detailsEn:"For medium-scale dairy processing.",detailsHi:"मध्यम स्तर के डेयरी प्रसंस्करण के लिए।",image:"kamdhenu-cream-separator-450-lph.svg"},
  {category:"dairy",brand:"Kamdhenu",nameEn:"Cream Separator 600 LPH",nameHi:"क्रीम सेपरेटर 600 एलपीएच",capacity:"600 LPH",detailsEn:"For commercial dairy processing.",detailsHi:"व्यावसायिक डेयरी प्रसंस्करण के लिए।",image:"kamdhenu-cream-separator-600-lph.svg"},
  {category:"dairy",brand:"Kamdhenu",nameEn:"Cream Separator 1000 LPH",nameHi:"क्रीम सेपरेटर 1000 एलपीएच",capacity:"1000 LPH",detailsEn:"High-throughput equipment for large dairy operations.",detailsHi:"बड़े डेयरी संचालन के लिए उच्च क्षमता वाला उपकरण।",image:"kamdhenu-cream-separator-1000-lph.svg"},
  {category:"dairy",brand:"Master",nameEn:"ClaLactomat Rapid with Stirrer (LM2)",nameHi:"क्लैलैक्टोमैट रैपिड स्टिरर के साथ (एलएम2)",capacity:"LM2",detailsEn:"Digital milk analyser supplied with a dedicated stirrer.",detailsHi:"समर्पित स्टिरर के साथ डिजिटल मिल्क एनालाइज़र।",image:"milk-analyser-clalactomat-rapid-lm2.svg"},
  {category:"dairy",brand:"Master",nameEn:"Classic DPS with Ultrasonic Stirrer & 60 Kg Scale",nameHi:"क्लासिक डीपीएस अल्ट्रासोनिक स्टिरर और 60 किग्रा स्केल के साथ",capacity:"DPS · 60 Kg scale",detailsEn:"Milk analyser setup with ultrasonic stirrer and weighing scale.",detailsHi:"अल्ट्रासोनिक स्टिरर और वजन मापने वाले स्केल के साथ मिल्क एनालाइज़र सेटअप।",image:"milk-analyser-classic-dps-ultrasonic-scale.svg"},
  {category:"dairy",brand:"Master",nameEn:"Classic LM2 with Stirrer",nameHi:"क्लासिक एलएम2 स्टिरर के साथ",capacity:"LM2",detailsEn:"Digital milk analyser paired with a separate stirrer.",detailsHi:"अलग स्टिरर के साथ डिजिटल मिल्क एनालाइज़र।",image:"milk-analyser-classic-lm2-stirrer.svg"},
  {category:"dairy",brand:"Master",nameEn:"Classic with Printer & Stirrer",nameHi:"क्लासिक प्रिंटर और स्टिरर के साथ",capacity:"Printer & stirrer",detailsEn:"Milk analyser configuration with integrated printing and a stirrer.",detailsHi:"प्रिंटिंग सुविधा और स्टिरर वाला मिल्क एनालाइज़र कॉन्फ़िगरेशन।",image:"milk-analyser-classic-printer-stirrer.svg"},
  {category:"dairy",brand:"Master",nameEn:"Eco with Stirrer",nameHi:"इको स्टिरर के साथ",capacity:"Eco series",detailsEn:"Compact digital milk analyser supplied with a stirrer.",detailsHi:"स्टिरर के साथ कॉम्पैक्ट डिजिटल मिल्क एनालाइज़र।",image:"milk-analyser-master-eco-stirrer.svg"},
  {category:"dairy",brand:"Sumo",nameEn:"Impart AC/DC with Weighing Scale",nameHi:"इम्पार्ट एसी/डीसी वजन स्केल के साथ",capacity:"AC/DC · weighing scale",detailsEn:"AC/DC milk analyser setup supplied with a weighing scale.",detailsHi:"वजन मापने वाले स्केल के साथ एसी/डीसी मिल्क एनालाइज़र सेटअप।",image:"milk-analyser-sumo-impart-ac-dc-scale.svg"},
  {category:"dairy",brand:"National",nameEn:"Khoya Making Machine — Electric & Gas",nameHi:"खोया बनाने की मशीन — इलेक्ट्रिक और गैस",capacity:"Electric & gas",detailsEn:"Khoya making machine designed for electric or gas operation.",detailsHi:"इलेक्ट्रिक या गैस से चलने के लिए बनाई गई खोया मशीन।",image:"khoya-machine-electric-gas.svg"},
  {category:"dairy",brand:"National",nameEn:"Khoya Making Machine — Electric, Diesel & Gas",nameHi:"खोया बनाने की मशीन — इलेक्ट्रिक, डीज़ल और गैस",capacity:"Electric, diesel & gas",detailsEn:"Khoya making machine designed for electric, diesel or gas operation.",detailsHi:"इलेक्ट्रिक, डीज़ल या गैस से चलने के लिए बनाई गई खोया मशीन।",image:"khoya-machine-electric-diesel-gas.svg"},
  {category:"cleaning",brand:"Everest",nameEn:"Scooter Washer 100 PSI",nameHi:"स्कूटर वॉशर 100 पीएसआई",capacity:"100 PSI",detailsEn:"Compact washer for scooters and two-wheelers.",detailsHi:"स्कूटर और दोपहिया वाहनों के लिए कॉम्पैक्ट वॉशर।",image:"everest-scooter-washer-100-psi.svg"},
  {category:"cleaning",brand:"Everest",nameEn:"Car Washer Single Cylinder 175 PSI",nameHi:"कार वॉशर सिंगल सिलेंडर 175 पीएसआई",capacity:"175 PSI",detailsEn:"Single-cylinder washer for cars and trucks.",detailsHi:"कार और ट्रक की सफाई के लिए सिंगल-सिलेंडर वॉशर।",image:"everest-car-washer-175-psi.svg"},
  {category:"cleaning",brand:"Everest",nameEn:"Car Washer Single Cylinder 250 PSI",nameHi:"कार वॉशर सिंगल सिलेंडर 250 पीएसआई",capacity:"250 PSI",detailsEn:"Premium single-cylinder equipment for vehicle washing.",detailsHi:"वाहन धुलाई के लिए प्रीमियम सिंगल-सिलेंडर उपकरण।",image:"everest-car-washer-250-psi.svg"},
  {category:"cleaning",brand:"Everest",nameEn:"Car Washer Double Cylinder 300 PSI",nameHi:"कार वॉशर डबल सिलेंडर 300 पीएसआई",capacity:"300 PSI",detailsEn:"Double-cylinder washer for higher-throughput vehicle cleaning.",detailsHi:"अधिक क्षमता वाली वाहन सफाई के लिए डबल-सिलेंडर वॉशर।",image:"everest-double-cylinder-car-washer-300-psi.svg"},
  {category:"cleaning",brand:"Everest",nameEn:"Industrial Washer 400 PSI",nameHi:"इंडस्ट्रियल वॉशर 400 पीएसआई",capacity:"400 PSI",detailsEn:"Heavy-duty equipment for industrial cleaning.",detailsHi:"औद्योगिक सफाई के लिए हेवी-ड्यूटी उपकरण।",image:"everest-industrial-washer-400-psi.svg"},
  {category:"motors",brand:"SONEE-DX",nameEn:"Electric Motor 1 HP",nameHi:"इलेक्ट्रिक मोटर 1 एचपी",capacity:"1 HP · SDX01",detailsEn:"Single-phase, four-pole, foot-mounted general-purpose motor.",detailsHi:"सिंगल-फेज, चार-पोल, फुट-माउंटेड सामान्य उपयोग की मोटर।",image:"sonee-dx-electric-motor-1-hp.svg"},
  {category:"motors",brand:"SONEE-DX",nameEn:"Electric Motor 2 HP",nameHi:"इलेक्ट्रिक मोटर 2 एचपी",capacity:"2 HP · SDX02",detailsEn:"Single-phase, four-pole, foot-mounted machinery drive.",detailsHi:"सिंगल-फेज, चार-पोल, फुट-माउंटेड मशीनरी ड्राइव।",image:"sonee-dx-electric-motor-2-hp.svg"},
  {category:"motors",brand:"SONEE-DX",nameEn:"Electric Motor 3 HP",nameHi:"इलेक्ट्रिक मोटर 3 एचपी",capacity:"3 HP · SDX03",detailsEn:"Single-phase, four-pole motor for general machinery.",detailsHi:"सामान्य मशीनरी के लिए सिंगल-फेज, चार-पोल मोटर।",image:"sonee-dx-electric-motor-3-hp.svg"},
  {category:"motors",brand:"SONEE-DX",nameEn:"Electric Motor 5 HP",nameHi:"इलेक्ट्रिक मोटर 5 एचपी",capacity:"5 HP · SONEE-DX-5",detailsEn:"Heavy general-purpose drive with cast-iron body.",detailsHi:"कास्ट-आयरन बॉडी वाली हेवी सामान्य उपयोग की ड्राइव।",image:"sonee-dx-electric-motor-5-hp.svg"},
  {category:"pumps",brand:"Texmo",nameEn:"DMS-2",nameHi:"डीएमएस-2",capacity:"DMS-2",detailsEn:"Slow-speed self-priming pump for domestic supply, tank filling and washing.",detailsHi:"घरेलू जल आपूर्ति, टंकी भरने और धुलाई के लिए धीमी गति का सेल्फ-प्राइमिंग पंप।",image:"texmo-dms-2-water-pump.svg"},
  {category:"pumps",brand:"Texmo",nameEn:"DMS-2 (N)",nameHi:"डीएमएस-2 (एन)",capacity:"DMS-02N · 0.5 HP",detailsEn:"Self-priming domestic water-supply pump.",detailsHi:"घरेलू जल आपूर्ति के लिए सेल्फ-प्राइमिंग पंप।",image:"texmo-dms-2-n-water-pump.svg"},
  {category:"pumps",brand:"Texmo",nameEn:"DMS-3",nameHi:"डीएमएस-3",capacity:"DMS-3 · 1 HP",detailsEn:"Self-priming pump for tank filling, pressure boosting and washing.",detailsHi:"टंकी भरने, दबाव बढ़ाने और धुलाई के लिए सेल्फ-प्राइमिंग पंप।",image:"texmo-dms-3-water-pump.svg"},
  {category:"pumps",brand:"Texmo",nameEn:"DMS-3 (N)",nameHi:"डीएमएस-3 (एन)",capacity:"DMS-03N · 1 HP",detailsEn:"Domestic monoblock pump for reliable water supply.",detailsHi:"भरोसेमंद जल आपूर्ति के लिए घरेलू मोनोब्लॉक पंप।",image:"texmo-dms-3-n-water-pump.svg"},
  {category:"pumps",brand:"Texmo",nameEn:"SCM 1150",nameHi:"एससीएम 1150",capacity:"SCM 1150",detailsEn:"Surface water pump for everyday transfer requirements.",detailsHi:"दैनिक जल स्थानांतरण आवश्यकताओं के लिए सरफेस वॉटर पंप।",image:"texmo-scm-1150-water-pump.svg"},
  {category:"pumps",brand:"Texmo",nameEn:"ACS-1575",nameHi:"एसीएस-1575",capacity:"ACS-1575",detailsEn:"Surface pumping solution for domestic and commercial use.",detailsHi:"घरेलू और व्यावसायिक उपयोग के लिए सरफेस पंपिंग समाधान।",image:"texmo-acs-1575-water-pump.svg"},
  {category:"pumps",brand:"Texmo",nameEn:"ACS-2280",nameHi:"एसीएस-2280",capacity:"ACS-2280",detailsEn:"Higher-duty surface pumping equipment.",detailsHi:"अधिक क्षमता वाला सरफेस पंपिंग उपकरण।",image:"texmo-acs-2280-water-pump.svg"},
  ...
  {category:"pulverisers",brand:"Multiple Brands",nameEn:"Pulveriser 1 HP",nameHi:"पल्वराइज़र 1 एचपी",capacity:"1 HP",detailsEn:"Compact pulveriser for small-batch grinding requirements.",detailsHi:"कम मात्रा की पिसाई के लिए कॉम्पैक्ट पल्वराइज़र।",image:"pulveriser-1-hp.svg"},
  {category:"pulverisers",brand:"Multiple Brands",nameEn:"Pulveriser 2 HP",nameHi:"पल्वराइज़र 2 एचपी",capacity:"2 HP",detailsEn:"Pulveriser for higher-output commercial grinding requirements.",detailsHi:"अधिक उत्पादन वाली व्यावसायिक पिसाई के लिए पल्वराइज़र।",image:"pulveriser-2-hp.svg"},
  {category:"compressors",brand:"Multiple Brands",nameEn:"Oil-Free Air Compressor 60 L",nameHi:"ऑयल-फ्री एयर कंप्रेसर 60 लीटर",capacity:"60 L · 750 W",detailsEn:"Oil-free compressor for workshop and general-purpose air supply.",detailsHi:"वर्कशॉप और सामान्य उपयोग की वायु आपूर्ति के लिए ऑयल-फ्री कंप्रेसर।",image:"oil-free-air-compressor-60-l.svg"},
  {category:"compressors",brand:"Neptune",nameEn:"Air Compressor 50 L",nameHi:"एयर कंप्रेसर 50 लीटर",capacity:"50 L · 3 HP",detailsEn:"Portable compressor for workshop and general-purpose pneumatic work.",detailsHi:"वर्कशॉप और सामान्य न्यूमैटिक कार्य के लिए पोर्टेबल कंप्रेसर।",image:"neptune-air-compressor-50-l-3-hp.svg"},
];
...
const productCategories: {id: ProductCategory; en: string; hi: string; noteEn: string; noteHi: string}[] = [
  ...
  {id:"pulverisers", en:"Pulverisers", hi:"पल्वराइज़र", noteEn:"Grinding equipment", noteHi:"पिसाई उपकरण"},
...
const copy = {
  en: {
    ...
    products: "Machinery for every requirement", productSub: "Explore 51 products with catalogue-matched brands, capacities and photographs.",
  ...
  hi: {
    ...
    products: "हर जरूरत के लिए मशीनरी", productSub: "कैटलॉग से मिलाए गए ब्रांड, क्षमता और तस्वीरों सहित 51 उत्पाद देखें।",
...
export default function Home() {
  ...
  return <main className={edit ? "editing" : ""}>
    ...
    <section className="brochures section" id="brochures"><div className="brochure-heading"><div><div className="section-kicker">BROCHURES · ब्रोशर</div><h2>{lang === "en" ? "Download our product brochures" : "हमारे उत्पाद ब्रोशर डाउनलोड करें"}</h2></div><p>{lang === "en" ? "Keep our dairy and agricultural machinery ranges handy for easy reference." : "आसान जानकारी के लिए हमारी डेयरी और कृषि मशीनरी की रेंज अपने पास रखें।"}</p></div><div className="brochure-grid"><article><span className="brochure-icon" aria-hidden="true">PDF</span><div><small>{lang === "en" ? "DAIRY EQUIPMENT" : "डेयरी उपकरण"}</small><h3>{lang === "en" ? "Dairy Products Brochure" : "डेयरी उत्पाद ब्रोशर"}</h3><p>{lang === "en" ? "Cream separators and dairy equipment from Soni Machinery Stores." : "सोनी मशीनरी स्टोर्स के क्रीम सेपरेटर और डेयरी उपकरण।"}</p></div><div className="brochure-actions"><a className="btn" href={`${assetBase}/soni-machinery-dairy-brochure.pdf`} target="_blank" rel="noreferrer">{lang === "en" ? "Open brochure" : "ब्रोशर खोलें"}</a><a href={`${assetBase}/soni-machinery-dairy-brochure.pdf`} download>{lang === "en" ? "Download PDF" : "पीडीएफ डाउनलोड करें"}</a></div></article><article><span className="brochure-icon" aria-hidden="true">PDF</span><div><small>{lang === "en" ? "AGRICULTURAL MACHINERY" : "कृषि मशीनरी"}</small><h3>{lang === "en" ? "Agricultural Products Brochure" : "कृषि उत्पाद ब्रोशर"}</h3><p>{lang === "en" ? "Agricultural machines and field equipment available from our store." : "हमारे स्टोर पर उपलब्ध कृषि मशीनें और खेत के उपकरण।"}</p></div><div className="brochure-actions"><a className="btn" href={`${assetBase}/soni-machinery-agricultural-brochure.pdf`} target="_blank" rel="noreferrer">{lang === "en" ? "Open brochure" : "ब्रोशर खोलें"}</a><a href={`${assetBase}/soni-machinery-agricultural-brochure.pdf`} download>{lang === "en" ? "Download PDF" : "पीडीएफ डाउनलोड करें"}</a></div></article></div></section>
