...
const copy = {
  en: {
    ...
    products: "Machinery for every requirement", productSub: "Explore 53 products with catalogue-matched brands, capacities and photographs.",
  ...
  hi: {
    ...
    products: "हर जरूरत के लिए मशीनरी", productSub: "कैटलॉग से मिलाए गए ब्रांड, क्षमता और तस्वीरों सहित 53 उत्पाद देखें।",
