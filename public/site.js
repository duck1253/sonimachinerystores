(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "Machinery that works as hard as you do.":"मशीनरी जो आपके जितनी मेहनत करे।","Powering Progress, Serving with Integrity.":"प्रगति को शक्ति, सेवा में सच्चाई।","Dependable agricultural, dairy and general-purpose machinery—supported by practical advice and honest service across generations.":"भरोसेमंद कृषि, डेयरी और सामान्य उपयोग की मशीनरी—पीढ़ियों के अनुभव, सही सलाह और ईमानदार सेवा के साथ।","Get the right machine →":"सही मशीन चुनें →","Explore all 53 machinery products":"सभी 53 मशीनरी उत्पाद देखें",
    "Machinery for every requirement":"हर जरूरत के लिए मशीनरी","Explore 53 products with catalogue-matched brands, capacities and photographs.":"कैटलॉग से मिलाए गए ब्रांड, क्षमता और तस्वीरों सहित 53 उत्पाद देखें।","Browse the complete machinery catalogue →":"पूरी मशीनरी सूची देखें →",
    ...
    "Let’s find the right machine for your work.":"आपके काम के लिए सही मशीन चुनते हैं।","Call now":"अभी कॉल करें","Book appointment":"अपॉइंटमेंट लें","Get directions":"दिशा-निर्देश पाएँ","Download brochure":"ब्रोशर डाउनलोड करें","View all 53 machinery products":"सभी 53 मशीनरी उत्पाद देखें","← Back to Home":"← होम पर वापस जाएँ",
  ...
  Object.entries({
    "All":"सभी","All Products":"सभी उत्पाद","Back to Home":"होम पर वापस जाएँ","View all 53 products":"सभी 53 उत्पाद देखें","Showing all 53 products with catalogue-matched brands, capacities and photographs.":"कैटलॉग से मिलाए गए ब्रांड, क्षमता और तस्वीरों सहित सभी 53 उत्पाद दिखाए जा रहे हैं।","Search and filter the complete catalogue →":"पूरी सूची खोजें और फ़िल्टर करें →","CUSTOMER VOICES":"ग्राहकों की बात","Customer Voices":"ग्राहकों की आवाज़",
